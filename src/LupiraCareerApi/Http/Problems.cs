...
/// <summary>Shared helpers for emitting RFC 7807 ProblemDetails responses, so the wire shape is consistent —
/// <c>application/problem+json</c> with <c>{ type, title, detail, status }</c>.</summary>
